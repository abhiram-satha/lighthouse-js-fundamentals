...
describe('nameInverter', function() {
  ...
  it("stretch: return a last-name, first name without any white spaces", function() {
    const inputName = ' first last';
    const expectedOutput = 'last, first';

    assert.equal(nameInverter(inputName), expectedOutput);
  })
  it('should return an empty string when passed a single honorfic', function() {
    const inputName = 'Dr.';
    const expectedOutput = "";
